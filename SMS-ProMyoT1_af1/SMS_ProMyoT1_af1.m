...
%This demo will generate SMS-ProMyoT1 for MB 2 and 3 without in-plane
%acceleration (af=1)
...
try
    ...
    Ny =  str2num(ProMyoT1Parameters{4});
...
%          
            ...
            for ipattern = 1
                ...
                if write_flag
                    ...
                    nameseq =  sprintf('SMS_ProMyoT1_MB%1.0f_Bl%1.0f_af%1.1f_NyAcq%.0f_fovr%.0f_fovp%.0f_TD%3.0f_ACS%1.0f_B1%.0f_TR%01.01f_zg%2.0f_st%1.0f_nLacs%2.0f_nLFS%2.0f_TI8aci%1.0f',  ...
                    ...
                    path_base = ['./' date '_nl/'];
                    path_save = sprintf('SMSProMyoT1af1/MB%1.0f_B1max%01.0f/st%1.0f/zg%2.0f/af%1.1f', ...
